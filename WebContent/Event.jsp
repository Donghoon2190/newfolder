...
<title>Event &mdash; Free Website Template, Free HTML5 Template
							...
							<c:if test="${level >1}">
								<li class="has-dropdown"><a>Management</a>
									<ul class="dropdown">
										...
										<c:if test="${level >2}">
											<li><a href="GetStoreInfo">Launching</a></li>
										</c:if>
									</ul></li>
							</c:if>
						...
						<div class="row row-mt-15em">
							<div class="col-md-12 mt-text animate-box"
								...
								<span class="intro-text-small">Made by <a
									href="http://gettemplates.co" target="_blank">NewFolder</a></span>
				...
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-4">
							...
							<div class="col-md-6 col-sm-6">
								<button type="submit" class="btn btn-default btn-block" onclick="location.href='CouponReg?coupon=9999999999&id=${id}'">Apply</button>
							</div>
					</div>
				</div>
			</div>
