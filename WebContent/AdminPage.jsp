...
<body>
	...
	<div id="page">
		...
		<header id="gtco-header" class="gtco-cover gtco-cover-sm"
			role="banner"
			style="background-image: url(images/img_bg_3.jpg); text-align: center; height: 20vw;">
			<div class="overlay"></div>
			<div class="gtco-container" style="">
				<div class="row" style="text-align: center; height: 20vw;">

					<div class="col-md-12 col-md-offset-0 text-center">
						<h1 class="cursive-font" style="margin-top: 9vw;">"Stores"</h1>
		...
		<div class="overlay"></div>
			<div class="gtco-container" style="">
				<div class="row" style="text-align: center; height: 20vw;">
					<div class="col-md-12 col-md-offset-0 text-center">
						...
						<table class="ta" style="padding: 3px;">
						<colgroup>
						<col width="30%">
						<col width="30%">
						<col width="30%">
					...
					<c:forEach items="${Rlist }" var="list">
								<tr>
									<td>${list.getStoreName()}</td>
									<td>${list.getStoreAdd()}</td>
									<td>${list.getStoreComment()}</td>
									<td>R</td>
								</tr>
							</c:forEach>
						 ...
						 <c:if test="${paging.page<=1}"> <a> 이전</a> </c:if>

						<!-- 현재 페이지가 1페이지 보다 클 경우 -->
						<c:if test="${paging.page>1}">
							<a href="GetStoreInfo?page=${paging.page-1}">이전</a>&nbsp; </c:if>
						...
						<c:forEach begin="${paging.startPage}" end="${paging.endPage}"
							...
							<c:choose>
								...
								<c:otherwise>
									<a href="GetStoreInfo?page=${i}" style="text-decoration: none;"
										id="aa">${i}</a>
			...
			&nbsp;<a href="GetStoreInfo?page=${paging.page+1}" id="a">다음</a>
						</c:if> 
					</div>
